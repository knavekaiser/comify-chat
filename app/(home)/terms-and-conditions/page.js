...
const terms = [
  {
    ...
    description:
      "By accessing or using the services provided by Comify Chat, you agree to comply with the following Terms and Conditions. These terms apply to all users and visitors of our website and services. If you do not agree with any of these terms, please refrain from using our services.",
  },
  {
    title: "Service Description",
    description:
      "Comify Chat offers AI-powered chatbot solutions designed to enhance customer engagement and support on websites. Our services utilize advanced technology to provide features such as automation, personalization, and knowledge-based responses. By implementing our chatbot service, businesses can streamline their customer interactions and deliver tailored experiences.",
  },
  {
    title: "User Responsibilities",
    description:
      "As a user of Comify Chat's services, you are responsible for maintaining the security of your account credentials. You agree not to misuse or interfere with the services or the experience of other users. It is important to protect your login information and promptly notify us if you suspect any unauthorized access or suspicious activities related to your account.",
  },
  {
    title: "Intellectual Property",
    description:
      "All intellectual property rights related to our services, including software, logos, content, and any other materials, are the property of Comify Chat or its licensors. These materials are protected by copyright and other applicable laws. You may not reproduce, distribute, modify, or create derivative works from any part of our services without obtaining explicit permission from us.",
  },
  {
    title: "Privacy",
    description: (
      <>
        Comify Chat values your privacy and is committed to protecting your
  ...
  },
  {
    title: "Contact Us",
    description:
      "If you have any questions, concerns, or inquiries regarding these Terms and Conditions, please do not hesitate to contact us. You can reach us at support@comify.in, and we will be happy to assist you.",
  },
];
